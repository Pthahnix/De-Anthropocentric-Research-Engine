...
- Sources: 9 resolvable v3 nodes from architecture `old`; one architecture alias (`construct-competing-hypotheses`) has no current directory and is not invented.
