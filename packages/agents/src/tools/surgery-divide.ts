// packages/agents/src/tools/surgery-divide.ts
...
const SYSTEM_PROMPT = readFileSync(join(__dirname, '../prompts/surgery-divide.md'), 'utf-8');

export async function surgeryDivide(params: {
  idea: string;
  context: string;
