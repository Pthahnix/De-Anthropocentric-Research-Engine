// packages/agents/src/tools/scamper-put-other-use.ts
...
const SYSTEM_PROMPT = readFileSync(join(__dirname, '../prompts/scamper-put-other-use.md'), 'utf-8');

export async function scamperPutOtherUse(params: {
  idea: string;
  context: string;
