// packages/agents/src/tools/surgery-subtract.ts
...
const SYSTEM_PROMPT = readFileSync(join(__dirname, '../prompts/surgery-subtract.md'), 'utf-8');
...
export async function surgerySubtract(params: {
  idea: string;
  context: string;
