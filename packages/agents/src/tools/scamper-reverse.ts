// packages/agents/src/tools/scamper-reverse.ts
...
const SYSTEM_PROMPT = readFileSync(join(__dirname, '../prompts/scamper-reverse.md'), 'utf-8');

export async function scamperReverse(params: {
  idea: string;
  context: string;
