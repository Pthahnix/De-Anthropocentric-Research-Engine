// packages/agents/src/tools/surgery-multiply.ts
...
const SYSTEM_PROMPT = readFileSync(join(__dirname, '../prompts/surgery-multiply.md'), 'utf-8');

export async function surgeryMultiply(params: {
  idea: string;
  context: string;
