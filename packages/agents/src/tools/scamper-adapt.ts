// packages/agents/src/tools/scamper-adapt.ts
...
const SYSTEM_PROMPT = readFileSync(join(__dirname, '../prompts/scamper-adapt.md'), 'utf-8');

export async function scamperAdapt(params: {
  idea: string;
  context: string;
