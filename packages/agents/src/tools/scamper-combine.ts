// packages/agents/src/tools/scamper-combine.ts
...
const SYSTEM_PROMPT = readFileSync(join(__dirname, '../prompts/scamper-combine.md'), 'utf-8');

export async function scamperCombine(params: {
  idea: string;
  secondIdea: string;
  context: string;
